...
function generateComprehensiveMeetingNotes(captions, meeting) {
  ...
  notes += `This meeting took place on ${new Date(meeting.scheduledTime).toLocaleDateString()} and lasted ${meeting.duration} minutes. The discussion involved ${speakers.length} participant${speakers.length > 1 ? 's' : ''}: ${speakers.join(', ')}.\n\n`;
